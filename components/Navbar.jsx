...
export default function Navbar() {
  ...
  return (
    <header
      className={`fixed left-1/2 -translate-x-1/2 z-50 transition-all duration-500 w-[95%] max-w-7xl rounded-full ${
        scrolled ? 'top-4 glass-dark py-2 px-6 border border-white/10' : 'top-6 bg-transparent py-4 px-6'
      }`}
    >
      <div className="flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center gap-3 group">
          <Image 
            ...
            height={80} 
            priority
            className="h-20 w-auto object-contain drop-shadow-[0_2px_10px_rgba(255,255,255,0.2)] py-1" 
          />
        </Link>
