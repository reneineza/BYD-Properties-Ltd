        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <AnimatedSection direction="right">
            ...
            <p className="text-gray-500 leading-relaxed">
              Today, our portfolio spans residential developments, commercial towers, and exclusive
              property sales — all underpinned by the same founding commitment: to build with
              integrity and deliver with pride.
            </p>
          </AnimatedSection>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {displayTeam.map((member, i) => (
              <AnimatedSection key={member.name || i} delay={i * 0.1} className="text-center">
                <div className="w-24 h-24 bg-navy rounded-full flex items-center justify-center mx-auto mb-4 text-gold font-display font-bold text-2xl overflow-hidden relative">
                  {member.image ? (
                ...
                <h4 className="font-display font-bold text-navy">{member.name}</h4>
