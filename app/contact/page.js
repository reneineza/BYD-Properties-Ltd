  ...
  const contactInfo = [
    {
      ...
      label: 'Address',
      value: contact.address || 'Kigali, Rwanda',
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
      ...
      label: 'Phone',
      value: contact.phone || '+250 788 661 932',
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
      ...
      label: 'Email',
      value: contact.email || 'info@bydproperties.rw',
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
      ...
      label: 'Working Hours',
      value: contact.workingHours || 'Mon – Fri: 9:00 AM – 6:00 PM',
    },
  ];

  const whatsappNumber = contact.whatsapp || '250788661932';
      ...
      <section className="py-24 bg-cream">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <AnimatedSection direction="right">
            ...
            {/* WhatsApp */}
            <a
              href={`https://wa.me/${whatsappNumber.replace(/\D/g, '')}?text=Hello%20BYD%20Properties!%20I%20am%20interested%20in%20your%20real%20estate%20services.`}
              target="_blank"
