...
<body style="margin:0;padding:0;background:${C.navyDark};font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;">
...
function heading(text) {
  return `<h1 style="margin:0 0 20px;font-size:28px;font-weight:700;
                   color:${C.white};line-height:1.25;">${text}</h1>`;
}

function body(text) {
  return `<p style="margin:0 0 16px;font-size:15px;color:${C.textBody};
...
function infoRow(label, value) {
  ...
  <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:8px;">
    <tr>
      <td width="38%" style="font-size:12px;color:${C.textSub};padding:3px 0;">${label}</td>
      <td style="font-size:13px;font-weight:600;color:${C.white};padding:3px 0;">${value}</td>
    </tr>
  </table>`;
}
